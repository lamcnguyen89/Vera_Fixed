...
source .env && docker-compose -f docker-compose.dev.yml exec mongo /bin/sh -c "tar xvzf /dump.tar.gz && rm -rf /dump/sherlock && mongorestore --username sherlock_dev --password eJ69vujCfrs9k3 --authenticationDatabase sherlock_dev /dump"
